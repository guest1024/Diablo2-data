...
DEFAULT_INCLUDE = [
    ...
    'crawler/MANUAL_CURATED_PLAYBOOK.md',
    'crawler/manual_curated_urls.json',
    'crawler/manual_curated_urls.example.json',
    'crawler/manual_curated_rogue_camp_template.md',
    'crawler/state',
    'crawler/runs',
    'crawler/snapshots',
]
