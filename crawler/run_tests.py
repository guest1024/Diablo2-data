...
TEST_MODULES = [
    ...
    "crawler.tests.test_build_state_index",
    "crawler.tests.test_build_final_push_summary",
    "crawler.tests.test_build_release_note",
    "crawler.tests.test_build_crawler_reports",
    "crawler.tests.test_preflight_data_branch_push",
    "crawler.tests.test_first_data_branch_push",
    "crawler.tests.test_simulate_first_data_branch_push",
    "crawler.tests.test_export_page_catalog_partitions",
    "crawler.tests.test_export_source_health_partitions",
    "crawler.tests.test_export_latest_run_partitions",
