...
\copy temp_documents (doc_id, source_id, source_name, label, source_url, local_path, content_type, authority_tier, lane, title, text_content, char_count, metadata) FROM '/home/user/diablo2-data/crawler/artifacts/20260423T055744Z/postgres/data/documents.tsv' WITH (FORMAT csv, DELIMITER E'\t', QUOTE '"')
\copy temp_chunks (chunk_id, doc_id, source_id, source_name, source_url, label, title, lane, authority_tier, chunk_index, text_content, char_count, metadata) FROM '/home/user/diablo2-data/crawler/artifacts/20260423T055744Z/postgres/data/chunks.tsv' WITH (FORMAT csv, DELIMITER E'\t', QUOTE '"')
